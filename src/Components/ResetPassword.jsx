    ...
    const validateToken = async ()=>{
        try {
           // let res = await axios.get('http://localhost:8500/movieticketapi/user/alluserslist')
            let res = await axios.get('https://capstone-project-backend-3-jlch.onrender.com/movieticketapi/user/alluserslist')
    ...
    const onSubmit  =  async (values) =>{
        try {
           // const res = await axios.put('http://localhost:8500/movieticketapi/user/resetpassword',{...values,email})
            const res = await axios.put('https://capstone-project-backend-3-jlch.onrender.com/movieticketapi/user/resetpassword',{...values,email})
