...
const TheaterSelection = () => {
    const { email, movieToBook, setTheaterToBook } = useContext(BookingContext);
                ...
                {theatersList.map((item, index) => (
                    <div key={index} className="col">
                        <div className="card h-100">
                            <Formik
                                initialValues={{ date: '', seatNumber: '', time: '' }}
                                ...
                                {({ setFieldValue, values }) => (
                                    <Form style={{ width: "100%" }}>
                                        ...
                                        <div className="card-footer d-flex justify-content-center">
                                            <button type="submit" style={{ border: "none", background: "none", width: "100%", padding: "5px" }} className='text-center py-2' id='Book'>Book Ticket</button>
                                        </div>
                                    </Form>
                                )}
                            </Formik>
