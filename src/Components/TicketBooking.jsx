...
const TicketBooking = () => {
    ...
    const fetchMovieData = async () => {
        try {
            ...
            const res = await axios.get('https://capstone-project-backend-3-jlch.onrender.com/uploadapi/admin/allmovies')
    ...
    const fetchCarouselData = async () => {
        try {
            ...
            const imageRes = await axios.get('https://capstone-project-backend-3-jlch.onrender.com/uploadapi/admin/allimages')
